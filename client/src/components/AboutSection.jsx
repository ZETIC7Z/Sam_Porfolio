...
export const AboutSection = () => {
  ...
  const tabContent = {
    personal: "Passionate about building digital solutions that seamlessly connect form and function. When I'm not designing interfaces or engineering software, I am experimenting with cutting-edge AI developer tools, exploring emerging design trends, and contributing to open-source systems.",
    professional: "With 5+ years as a Design Engineer, I bridge user experience and software engineering to deliver end-to-end applications. I've launched 5+ production projects — including streaming services, enterprise dashboards, and gaming portals — by combining UI/UX design systems with full-stack development. I leverage next-generation AI platforms to accelerate my engineering workflow and ship clean, scalable code in record time.",
    approach: "My philosophy fuses human-centered UI/UX design with rapid, agentic software engineering. I utilize advanced AI development environments to handle heavy architecture lifting, giving me more space to focus on pixel-perfect user interfaces, robust database logic, and comprehensive testing. This hybrid approach enables me to turn complex product ideas into fully deployed software with maximum speed and precision."
  };
              ...
              <div className="relative">
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">Sam</h2>
