...
export const Footer = () => {
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "samxerz12@gmail.com", href: "mailto:samxerz12@gmail.com" },
    { icon: <Phone size={16} />, text: "+63310988089", href: "tel:+63310988089" },
  ];
    ...
    <footer className="px-6 py-12 mt-20">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            <div>
              <p>© 2026 ZETICUZ All rights reserved.</p>
            </div>
